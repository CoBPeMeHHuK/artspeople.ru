            ...
            <div class="user_information__container">
                <div class="user_information__option">
                    <div class="user_information__option_container">
                        ...
                        <label for="user_name"></label><input type="text" name="name" id="user_name" class="user_information__input form-control" v-model="settingName">
                    </div>
                    <div class="user_information__option_container">
                        <div class="user_information__title">Фамилия</div>
                        <label for="user_surname"></label><input type="text" name="surname" id="user_surname" class="user_information__input form-control" v-model="settingSurname">
                    </div>
                </div>
                <div class="user_information__option">
                    <div class="user_information__option_container">
                        <div class="user_information__title">Дата рождения</div>
                        <datepicker v-model="settingBirthday" :language="lang"  class="user_information__input form-control__custom"></datepicker>
                    </div>
                    <div class="user_information__option_container">
                        <div class="user_information__title">Телефон</div>
                        <label for="user_phone"></label><input type="text" name="surname" id="user_phone" class="user_information__input form-control" v-model="settingPhone">
                    </div>
                    <div class="user_information__option_container">
                        <div class="user_information__title">Дополнительный телефон</div>
                        <label for="user_additional_phone"></label><input type="text" name="email" id="user_additional_phone" class="user_information__input form-control" v-model="settingAdditionalPhone">
                    </div>
                    <div class="user_information__option_container">
                        <div class="user_information__title">Персональный сайт</div>
                        <label for="user_site"></label><input type="text" name="email" id="user_site" class="user_information__input form-control" v-model="settingPersonalSite">
                    </div>
                </div>
                <div class="user_information__option">
                    <div class="user_information__option_container">
                        <div class="user_information__title">Цитата</div>
                        <label for="user_quote"></label><textarea name="quote" id="user_quote" class="user_information__input form-control" v-model="settingQuote"></textarea>
                    </div>
                    <div class="user_information__option_container">
                        <div class="user_information__title">Интересы и увлечения</div>
                        <label for="user_about"></label><textarea name="about" id="user_about" class="user_information__input form-control" v-model="settingAbout"></textarea>
                    </div>
                </div>
            </div>
