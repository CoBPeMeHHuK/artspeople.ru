                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            ...
                            @if($article->type == 1 || $article->type !=2 || $article->type !=3 || $article->type !=4)
                                checked
                                @endif>
                            Превью нормальной ширины, половина экрана (рекомендуемый и минимальный размер 580x340)
                            </label>
                        </div>
                        <div class="radio">
                            <label for="optionsRadios2">
                                <input type="radio" name="optionsRadios" id="optionsRadios2" value="2"
                                       ...
                                       checked
                                    @endif>
                                Мини превью, один из трёх в ширине экрана (рекомендуемый и минимальный размер 380x300)
                            </label>
                        </div>
                        <div class="radio">
                            <label for="optionsRadios3">
                                <input type="radio" name="optionsRadios" id="optionsRadios3" value="3"
                                       ...
                                       checked
                                    @endif>
                                Самый большое превью (рекомендуемый и минимальный размер 780x340)
                            </label>
                        </div>
                        <div class="radio">
                            <label for="optionsRadios4">
                                <input type="radio" name="optionsRadios" id="optionsRadios4" value="4"
                                       ...
                                       checked
                                    @endif>
                                Дополнение к самому большому превью (рекомендуемый и минимальный размер 380x340)
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
